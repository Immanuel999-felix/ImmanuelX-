{
    "name": "IMMANUELX(IMD)",
    "version": "2.1.4",
    "description": "IMMANUELX(IMD) is a Powerful Whatsapp bot.   🙂🤖💻🖤",
    "main": "start.js",
    "scripts": {
        "start": "pm2 start start.js --deep-monitoring --attach --name wabot-immanuelxmd",
        "stop": "pm2 stop wabot-immanuelxmd",
        "restart": "pm2 restart wabot-immanuelxmd"
    },
    "dependencies": {
        ...
        "@whiskeysockets/baileys": "git+https://github.com/immanuel999-felix/Baileys-6.0.0.git#master",
        "api-dylux": "latest",
