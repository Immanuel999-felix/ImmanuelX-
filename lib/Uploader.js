...
//YouTube: @Immanuelfelix999
//Telegram: https://t.me/Imma_nuel999
//GitHub: @Immanuel999-felix
//WhatsApp: https://whatsapp.com/channel/0029VaioNMmADTOAj0T6Yw2s
 ...
 * @param {Object} _dir
 */
const expiredCheck = (TechTnsights, msg, _dir) => {
	setInterval(() => {
		let position = null;
		Object.keys(_dir).forEach((i) => {
		...
		if (position !== null) {
			...
			fs.writeFileSync("./database/premium.json", JSON.stringify(_dir));
			idny ? TechTnsights.sendMessage(idny, { text: "Your premium has run out, please buy again." }) : "";
			idny = false;
		}
	}, 1000);
};
